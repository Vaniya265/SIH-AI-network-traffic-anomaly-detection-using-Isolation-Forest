...
def preprocess_for_rf(data):
    ...
    # RF was trained with its own feature columns
    df = df.reindex(
...
def predict_one(data):
    ...
    # ======================================
    #
    # RF is ONLY consulted when
    # Isolation Forest says NORMAL.
    #
    # This preserves Isolation Forest
    # as the HERO model.
    # ======================================
    ...
    if prediction == 1:
        ...
        # ----------------------------------
        # RF catches an IF-missed attack
        # ----------------------------------
        ...
        if rf_raw_prediction == 1:
            ...
            # Give the secondary detection
            # a medium/high security response.
            #
            # We don't fabricate an IF risk
            # score, so we use a minimum
            # secondary-alert score.
